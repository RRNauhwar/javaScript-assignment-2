...
const resultMultiply = calculator.calculation.apply(calculator,["multiply",10,5])
console.log(resultMultiply)
const discountCalculator = {
    disPercent: 10,
    applyDiscount : function (price) {
        return price-(price*(this.disPercent/100))
    }
    }
const finalPrice = discountCalculator.applyDiscount.bind(discountCalculator)
